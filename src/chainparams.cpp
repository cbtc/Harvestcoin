...
public:
	CMainParams() {
		...
		const char* pszTimestamp = "08 Dec 2017 The Rising of Mycellium Masternode Coin ";
		...
		vSeeds.push_back(CDNSSeedData("0",  "188.166.172.111"));
		vSeeds.push_back(CDNSSeedData("1",  "88.20.74.19"));
